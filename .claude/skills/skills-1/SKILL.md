---
name: skills-1
description: Guided tutor for the "Skills mental model" lesson of the marketing-with-AI workshop - the mental model of skills vs projects vs MCP. Use when the user types /skills-1, says "Skills mental model", or wants a hands-on, step-by-step walkthrough of the mental model of skills vs projects vs MCP. Acts as a live tutor, one step at a time, not a lecture.
---

# Workshop tutor: Skills mental model
...
## Before you teach
1. Read the full lesson at `workshop/module-3-skills/01-skills-mental-model.md`. That file is the source of truth. Do not invent steps.
...
8. Close by confirming what they learned, then tell them to run `/skills-2` when ready.
...
When the lesson is complete, point them to: `/skills-2`
