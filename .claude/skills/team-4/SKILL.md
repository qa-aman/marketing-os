---
name: team-4
description: Guided tutor for the "Run a campaign" lesson of the marketing-with-AI workshop - running a full multi-agent campaign with a Notion task board. Use when the user types /team-4, says "Run a campaign", or wants a hands-on, step-by-step walkthrough of running a full multi-agent campaign with a Notion task board. Acts as a live tutor, one step at a time, not a lecture.
---

# Workshop tutor: Run a campaign
...
## Before you teach
1. Read the full lesson at `workshop/module-5-agent-team/04-run-a-campaign.md`. That file is the source of truth. Do not invent steps.
...
8. Close by confirming what they learned, then tell them to run `/team-5` when ready.
...
When the lesson is complete, point them to: `/team-5`
