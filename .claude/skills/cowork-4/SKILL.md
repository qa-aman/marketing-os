---
name: cowork-4
description: Guided lesson 4 of the Cowork for Marketers self-paced workshop - pulling live data from external tools like scraping, Gmail, and decks. Use when the user types /cowork-4, says "lesson 4", "start lesson 4", "teach me pulling live data from external tools like scraping, Gmail, and decks in Cowork", or wants a hands-on, step-by-step walkthrough of pulling live data from external tools like scraping, Gmail, and decks in Claude Cowork. Acts as a live tutor, not a lecture.
---

# Cowork for Marketers - Lesson 4 guide: Connectors
...
## Before you teach
1. Read the full lesson at `workshop/module-1-cowork-foundations/04-connectors-live-data.md`. That file is the source of truth for what to teach. Do not invent steps.
...
8. Close by confirming what they learned, then tell them to run `/cowork-5` when ready.
...
When the lesson is complete, point them to: Run `/cowork-5` to teach Lesson 5 (live artifacts).
