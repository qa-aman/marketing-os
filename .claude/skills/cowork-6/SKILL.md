---
name: cowork-6
description: Guided lesson 6 of the Cowork for Marketers self-paced workshop - packaging a workflow into a one-click reusable skill. Use when the user types /cowork-6, says "lesson 6", "start lesson 6", "teach me packaging a workflow into a one-click reusable skill in Cowork", or wants a hands-on, step-by-step walkthrough of packaging a workflow into a one-click reusable skill in Claude Cowork. Acts as a live tutor, not a lecture.
---

# Cowork for Marketers - Lesson 6 guide: Skills and plugins
...
## Before you teach
1. Read the full lesson at `workshop/module-1-cowork-foundations/06-skills-and-plugins.md`. That file is the source of truth for what to teach. Do not invent steps.
...
8. Close by confirming what they learned, then tell them to run `/cowork-7` when ready.
...
When the lesson is complete, point them to: Run `/cowork-7` to teach Lesson 7 (browser use).
