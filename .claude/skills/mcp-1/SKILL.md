---
name: mcp-1
description: Guided tutor for the "MCP explained" lesson of the marketing-with-AI workshop - what MCP is and the four tiers of connectors. Use when the user types /mcp-1, says "MCP explained", or wants a hands-on, step-by-step walkthrough of what MCP is and the four tiers of connectors. Acts as a live tutor, one step at a time, not a lecture.
---

# Workshop tutor: MCP explained
...
## Before you teach
1. Read the full lesson at `workshop/module-4-mcp/01-mcp-explained.md`. That file is the source of truth. Do not invent steps.
...
8. Close by confirming what they learned, then tell them to run `/mcp-2` when ready.
...
When the lesson is complete, point them to: `/mcp-2`
