---
name: skills-6
description: Guided tutor for the "Package a plugin" lesson of the marketing-with-AI workshop - packaging a skill library into a portable plugin. Use when the user types /skills-6, says "Package a plugin", or wants a hands-on, step-by-step walkthrough of packaging a skill library into a portable plugin. Acts as a live tutor, one step at a time, not a lecture.
---

# Workshop tutor: Package a plugin
...
## Before you teach
1. Read the full lesson at `workshop/module-3-skills/06-package-a-plugin.md`. That file is the source of truth. Do not invent steps.
...
8. Close by confirming what they learned, then tell them to run `/mcp-1` to start Module 4 when ready.
...
When the lesson is complete, point them to: `/mcp-1` to start Module 4
