---
name: team-2
description: Guided tutor for the "What every agent needs" lesson of the marketing-with-AI workshop - the three things every agent needs and the /agents command. Use when the user types /team-2, says "What every agent needs", or wants a hands-on, step-by-step walkthrough of the three things every agent needs and the /agents command. Acts as a live tutor, one step at a time, not a lecture.
---

# Workshop tutor: What every agent needs
...
## Before you teach
1. Read the full lesson at `workshop/module-5-agent-team/02-three-things-every-agent-needs.md`. That file is the source of truth. Do not invent steps.
...
8. Close by confirming what they learned, then tell them to run `/team-3` when ready.
...
When the lesson is complete, point them to: `/team-3`
