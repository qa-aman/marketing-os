---
name: mcp-3
description: Guided tutor for the "Five agents to copy" lesson of the marketing-with-AI workshop - building five task-executing agents with MCP. Use when the user types /mcp-3, says "Five agents to copy", or wants a hands-on, step-by-step walkthrough of building five task-executing agents with MCP. Acts as a live tutor, one step at a time, not a lecture.
---

# Workshop tutor: Five agents to copy
...
## Before you teach
1. Read the full lesson at `workshop/module-4-mcp/03-five-agents-to-copy.md`. That file is the source of truth. Do not invent steps.
...
8. Close by confirming what they learned, then tell them to run `/mcp-4` when ready.
...
When the lesson is complete, point them to: `/mcp-4`
