---
name: cowork-8
description: Guided lesson 8 of the Cowork for Marketers self-paced workshop - automating workflows into a self-updating marketing control center. Use when the user types /cowork-8, says "lesson 8", "start lesson 8", "teach me automating workflows into a self-updating marketing control center in Cowork", or wants a hands-on, step-by-step walkthrough of automating workflows into a self-updating marketing control center in Claude Cowork. Acts as a live tutor, not a lecture.
---

# Cowork for Marketers - Lesson 8 guide: Scheduled tasks
...
## Before you teach
1. Read the full lesson at `workshop/module-1-cowork-foundations/08-scheduled-tasks.md`. That file is the source of truth for what to teach. Do not invent steps.
...
8. Close by confirming what they learned, then tell them to run the course wrap-up when ready.
...
When the lesson is complete, point them to: They have finished the course. Congratulate them and suggest rebuilding every exercise on their own brand.
