---
name: cowork-2
description: Guided lesson 2 of the Cowork for Marketers self-paced workshop - building a strategy deck from a template plus brand photos. Use when the user types /cowork-2, says "lesson 2", "start lesson 2", "teach me building a strategy deck from a template plus brand photos in Cowork", or wants a hands-on, step-by-step walkthrough of building a strategy deck from a template plus brand photos in Claude Cowork. Acts as a live tutor, not a lecture.
---

# Cowork for Marketers - Lesson 2 guide: Templates
...
## Before you teach
1. Read the full lesson at `workshop/module-1-cowork-foundations/02-templates-strategy-deck.md`. That file is the source of truth for what to teach. Do not invent steps.
...
8. Close by confirming what they learned, then tell them to run `/cowork-3` when ready.
...
When the lesson is complete, point them to: Run `/cowork-3` to teach Lesson 3 (projects).
