---
name: cowork-0
description: Guided lesson 0 of the Cowork for Marketers self-paced workshop - installing Cowork and setting up your marketing folder structure. Use when the user types /cowork-0, says "lesson 0", "start lesson 0", "teach me installing Cowork and setting up your marketing folder structure in Cowork", or wants a hands-on, step-by-step walkthrough of installing Cowork and setting up your marketing folder structure in Claude Cowork. Acts as a live tutor, not a lecture.
---

# Cowork for Marketers - Lesson 0 guide: Setup
...
## Before you teach
1. Read the full lesson at `workshop/module-1-cowork-foundations/00-setup.md`. That file is the source of truth for what to teach. Do not invent steps.
...
8. Close by confirming what they learned, then tell them to run `/cowork-1` when ready.
...
When the lesson is complete, point them to: Run `/cowork-1` to teach Lesson 1 (workspace and context).
