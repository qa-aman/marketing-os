---
name: team-1
description: Guided tutor for the "Why a team and framework" lesson of the marketing-with-AI workshop - why an agent team beats one agent, and the four-step framework. Use when the user types /team-1, says "Why a team and framework", or wants a hands-on, step-by-step walkthrough of why an agent team beats one agent, and the four-step framework. Acts as a live tutor, one step at a time, not a lecture.
---

# Workshop tutor: Why a team and framework
...
## Before you teach
1. Read the full lesson at `workshop/module-5-agent-team/01-why-a-team-and-framework.md`. That file is the source of truth. Do not invent steps.
...
8. Close by confirming what they learned, then tell them to run `/team-2` when ready.
...
When the lesson is complete, point them to: `/team-2`
