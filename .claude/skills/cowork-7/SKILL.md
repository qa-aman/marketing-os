---
name: cowork-7
description: Guided lesson 7 of the Cowork for Marketers self-paced workshop - letting Cowork browse real websites and track AI search visibility. Use when the user types /cowork-7, says "lesson 7", "start lesson 7", "teach me letting Cowork browse real websites and track AI search visibility in Cowork", or wants a hands-on, step-by-step walkthrough of letting Cowork browse real websites and track AI search visibility in Claude Cowork. Acts as a live tutor, not a lecture.
---

# Cowork for Marketers - Lesson 7 guide: Browser use
...
## Before you teach
1. Read the full lesson at `workshop/module-1-cowork-foundations/07-browser-use.md`. That file is the source of truth for what to teach. Do not invent steps.
...
8. Close by confirming what they learned, then tell them to run `/cowork-8` when ready.
...
When the lesson is complete, point them to: Run `/cowork-8` to teach Lesson 8 (scheduled tasks).
