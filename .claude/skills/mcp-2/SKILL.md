---
name: mcp-2
description: Guided tutor for the "Notion marketing brain" lesson of the marketing-with-AI workshop - using Notion as your marketing brain via the connector. Use when the user types /mcp-2, says "Notion marketing brain", or wants a hands-on, step-by-step walkthrough of using Notion as your marketing brain via the connector. Acts as a live tutor, one step at a time, not a lecture.
---

# Workshop tutor: Notion marketing brain
...
## Before you teach
1. Read the full lesson at `workshop/module-4-mcp/02-notion-marketing-brain.md`. That file is the source of truth. Do not invent steps.
...
8. Close by confirming what they learned, then tell them to run `/mcp-3` when ready.
...
When the lesson is complete, point them to: `/mcp-3`
