---
name: team-5
description: Guided tutor for the "Remote control" lesson of the marketing-with-AI workshop - assigning tasks to your team from your phone. Use when the user types /team-5, says "Remote control", or wants a hands-on, step-by-step walkthrough of assigning tasks to your team from your phone. Acts as a live tutor, one step at a time, not a lecture.
---

# Workshop tutor: Remote control
...
## Before you teach
1. Read the full lesson at `workshop/module-5-agent-team/05-remote-control-mobile.md`. That file is the source of truth. Do not invent steps.
...
8. Close by confirming what they learned, then tell them to run `/models-1` to start Module 6 when ready.
...
When the lesson is complete, point them to: `/models-1` to start Module 6
