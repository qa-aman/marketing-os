---
name: models-1
description: Guided tutor for the "Claude plus Gemini" lesson of the marketing-with-AI workshop - pairing Claude and Gemini with a critique loop. Use when the user types /models-1, says "Claude plus Gemini", or wants a hands-on, step-by-step walkthrough of pairing Claude and Gemini with a critique loop. Acts as a live tutor, one step at a time, not a lecture.
---

# Workshop tutor: Claude plus Gemini
...
## Before you teach
1. Read the full lesson at `workshop/module-6-multi-model/01-claude-plus-gemini.md`. That file is the source of truth. Do not invent steps.
...
8. Close by confirming what they learned, then tell them to run `/models-2` when ready.
...
When the lesson is complete, point them to: `/models-2`
