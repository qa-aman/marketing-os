---
name: cowork-3
description: Guided lesson 3 of the Cowork for Marketers self-paced workshop - turning a repeatable workflow into a saved Cowork project with memory. Use when the user types /cowork-3, says "lesson 3", "start lesson 3", "teach me turning a repeatable workflow into a saved Cowork project with memory in Cowork", or wants a hands-on, step-by-step walkthrough of turning a repeatable workflow into a saved Cowork project with memory in Claude Cowork. Acts as a live tutor, not a lecture.
---

# Cowork for Marketers - Lesson 3 guide: Projects
...
## Before you teach
1. Read the full lesson at `workshop/module-1-cowork-foundations/03-projects-reusable-workflows.md`. That file is the source of truth for what to teach. Do not invent steps.
...
8. Close by confirming what they learned, then tell them to run `/cowork-4` when ready.
...
When the lesson is complete, point them to: Run `/cowork-4` to teach Lesson 4 (connectors).
