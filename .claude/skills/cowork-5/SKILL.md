---
name: cowork-5
description: Guided lesson 5 of the Cowork for Marketers self-paced workshop - building interactive dashboards that refresh themselves. Use when the user types /cowork-5, says "lesson 5", "start lesson 5", "teach me building interactive dashboards that refresh themselves in Cowork", or wants a hands-on, step-by-step walkthrough of building interactive dashboards that refresh themselves in Claude Cowork. Acts as a live tutor, not a lecture.
---

# Cowork for Marketers - Lesson 5 guide: Live artifacts
...
## Before you teach
1. Read the full lesson at `workshop/module-1-cowork-foundations/05-live-artifacts.md`. That file is the source of truth for what to teach. Do not invent steps.
...
8. Close by confirming what they learned, then tell them to run `/cowork-6` when ready.
...
When the lesson is complete, point them to: Run `/cowork-6` to teach Lesson 6 (skills and plugins).
