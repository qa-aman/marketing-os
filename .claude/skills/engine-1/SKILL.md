---
name: engine-1
description: Guided tutor for the "Repurpose content" lesson of the marketing-with-AI workshop - repurposing one blog post into social, newsletter, and LinkedIn. Use when the user types /engine-1, says "Repurpose content", or wants a hands-on, step-by-step walkthrough of repurposing one blog post into social, newsletter, and LinkedIn. Acts as a live tutor, one step at a time, not a lecture.
---

# Workshop tutor: Repurpose content
...
## Before you teach
1. Read the full lesson at `workshop/module-2-content-engine/01-repurpose-content.md`. That file is the source of truth. Do not invent steps.
...
8. Close by confirming what they learned, then tell them to run `/engine-2` when ready.
...
When the lesson is complete, point them to: `/engine-2`
