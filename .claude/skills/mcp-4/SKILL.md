---
name: mcp-4
description: Guided tutor for the "Custom MCP and security" lesson of the marketing-with-AI workshop - building a custom connector and the safety rules. Use when the user types /mcp-4, says "Custom MCP and security", or wants a hands-on, step-by-step walkthrough of building a custom connector and the safety rules. Acts as a live tutor, one step at a time, not a lecture.
---

# Workshop tutor: Custom MCP and security
...
## Before you teach
1. Read the full lesson at `workshop/module-4-mcp/04-custom-mcp-and-security.md`. That file is the source of truth. Do not invent steps.
...
8. Close by confirming what they learned, then tell them to run `/team-1` to start Module 5 when ready.
...
When the lesson is complete, point them to: `/team-1` to start Module 5
